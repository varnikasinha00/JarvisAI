...
class ChatSection(QWidget):
      ...
      def __init__(self):
            ...
            self.setStyleSheet("""
                  ...
                  background: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 #ffffff, stop:1 #bbbbbb);
                  min-height: 25px;
                  border-radius: 6px;
                  }

                  QScrollBar::handle:vertical:hover {
                  background: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 #dddddd, stop:1 #aaaaaa);
                  }
